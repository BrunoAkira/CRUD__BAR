...
import javafx.scene.control.cell.PropertyValueFactory;
	...
	public class ConsultaLoteController implements Initializable{
		...
		public void initialize(URL arg0, ResourceBundle arg1) {
			...
			cbTipo.getItems().addAll("Produto","Fornecedor", "Quantidade", "Custo Unitário");			
			...
			TableColumn colunaFornecedor = new TableColumn<Object, Object>("Fornecedor");
			colunaFornecedor.setCellValueFactory(new PropertyValueFactory<>("fornecedor"));
				
			TableColumn colunadataCompra = new TableColumn<Object, Object>("Data da Compra");
			colunadataCompra.setCellValueFactory(new PropertyValueFactory<>("dataCompra"));
			
			TableColumn colunaQuantidade = new TableColumn<Object, Object>("Quantidade");
			colunaQuantidade.setCellValueFactory(new PropertyValueFactory<>("quantidade"));
			
			TableColumn colunacustoUnit = new TableColumn<Object, Object>("Custo Unitário");
			colunacustoUnit.setCellValueFactory(new PropertyValueFactory<>("custoUnit"));

			tableEstoque.getColumns().clear();
			tableEstoque.getColumns().addAll(colunaId, colunaNome,colunaFornecedor,colunadataCompra,colunaQuantidade,colunacustoUnit);
